...
class TabDrink extends StatefulWidget {
  const TabDrink({super.key});

  @override
  State<TabDrink> createState() => _TabDrinkState();
}

class _TabDrinkState extends State<TabDrink> {
  RecipeList? _recipeList;
  bool isLoading = true;

  Future getApi() async {
    _recipeList = await ApiService().getDaftarResepByType("drink");
    setState(() {
      isLoading = false;
    });
  }
