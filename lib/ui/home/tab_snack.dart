...
class TabSnack extends StatefulWidget {
  const TabSnack({super.key});

  @override
  State<TabSnack> createState() => _TabSnackState();
}

class _TabSnackState extends State<TabSnack> {
  RecipeList? _recipeList;
  bool isLoading = true;

  Future getApi() async {
    _recipeList = await ApiService().getDaftarResepByType("snack");
    setState(() {
      isLoading = false;
    });
  }
